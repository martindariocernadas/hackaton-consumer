...
var kcl = require('.');
var controller = require('./modules/consumos/consumo.controller');

/**
 * Consumer para el stream de movimientos de base de datos.
 * Filtra los movimientos de compra y los guarda en una base mongoDB para que luego sean eplotados
 * por la app de descuentos
 */
